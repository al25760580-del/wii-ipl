...
#include <private/fa/PrFILE2/standard/pf_fseek.h>

// pf2_fseek - 0x815E548C, 36 bytes
// from ogws (Wii Sports VF, CC0)

pf_int32 pf2_fseek(struct PF_FILE* pFile, pf_s32 lOffset, int nOrigin) {
    pf_s32 err;
    err = PFAPI_convertReturnValue(PFFILE_fseek(pFile, lOffset, nOrigin));
    return err;
}
