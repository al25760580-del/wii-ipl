...
// decompilation, doldecomp/Petari, CC0-1.0; the same RVL_SDK build lineage as
// this binary). Covers the IPL's i2c TU exactly (sendSlaveAddr,
// __VISendI2CData); the additional Petari statics (VICheckI2C, __VIOpenI2C,
// __VIGetSDA/SetSDA/SetSCL, wait4ClkHigh) are not present in this binary and
// remain as extra code until objdiff confirms they can be pruned.
//
...
static void WaitMicroTime(s32 usec) {
    // static here: this build keeps the global WaitMicroTime in vi.c
