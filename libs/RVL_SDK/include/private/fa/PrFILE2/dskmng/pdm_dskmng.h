...
pf_s32 pdm_open_disk(PDM_INIT_DISK* p_init_disk_tbl, PDM_DISK** pp_disk);
pf_s32 pdm_close_disk(PDM_DISK* p_disk);
pf_s32 pdm_open_partition(PDM_DISK* p_disk, pf_s32 part_id, PDM_PARTITION** pp_part);
pf_s32 pdm_close_partition(PDM_PARTITION* p_part);
