...
pf_s32 pdm_bpb_load_string(const pf_u8* buf, pf_u32 length, pf_u8* p_string);
pf_s32 pdm_bpb_get_bpb_information(pf_u8* buf, PDM_BPB* p_bpb);
pf_s32 pdm_bpb_get_fsinfo_information(pf_u8* buf, PDM_FSINFO* p_fsinfo);
pf_s32 pdm_bpb_set_fsinfo_information(PDM_FSINFO* p_fsinfo, pf_u8* buf);
pf_s32 pdm_bpb_check_boot_sector(pf_u8* buf, pf_bool* is_boot);
pf_s32 pdm_bpb_check_fsinfo_sector(pf_u8* buf, pf_bool* is_fsinfo);
