...
pf_s32 pdm_mbr_get_table(pf_u8* buf, pf_u32 sector, PDM_MBR* p_mbr_tbl);
pf_s32 pdm_mbr_get_mbr_part_table(PDM_DISK* p_disk, PDM_MBR* p_mbr_tbl);
pf_s32 pdm_mbr_get_epbr_part_table(PDM_DISK* p_disk, PDM_MBR* p_mbr_tbl);
pf_s32 pdm_mbr_check_master_boot_record(PDM_DISK* p_disk, pf_u8* buf, pf_bool* is_master_boot);
