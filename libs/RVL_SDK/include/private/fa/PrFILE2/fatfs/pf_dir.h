...
pf_s32 PFDIR_fsfirst(PF_STR* p_path_str, pf_u8 attr, PF_DTA* p_dta);
pf_s32 PFDIR_fsnext(PF_DTA* p_dta);
pf_s32 PFDIR_rmdir(PF_STR* p_path_str);
pf_s32 PFDIR_mkdir(PF_STR* p_path_str);
pf_s32 PFDIR_chdir(PF_STR* p_path_str);
